...
export const idlService = IDL.Service({
  ...
  'filterLeadsBySource' : IDL.Func([IDL.Text], [IDL.Vec(Lead)], ['query']),
  'filterLeadsByStatus' : IDL.Func([IDL.Text], [IDL.Vec(Lead)], ['query']),
  'getCallerUserRole' : IDL.Func([], [UserRole], ['query']),
  'getGalleryItems' : IDL.Func([], [IDL.Vec(GalleryItem)], ['query']),
  'getInteraktWebhookUrl' : IDL.Func([], [IDL.Text], ['query']),
  ...
  'setInteraktWebhookUrl' : IDL.Func([IDL.Text], [], []),
  'setSiteSetting' : IDL.Func([IDL.Text, IDL.Text], [], []),
  'submitLead' : IDL.Func(
      [IDL.Text, IDL.Text, IDL.Text, IDL.Text, IDL.Text],
      [IDL.Nat],
      [],
    ),
  'triggerInteraktNotification' : IDL.Func(
      [IDL.Text, IDL.Text, IDL.Text],
      [IDL.Text],
      [],
    ),
  'updateGalleryItem' : IDL.Func(
      [IDL.Nat, IDL.Text, IDL.Text, IDL.Text, ExternalBlob, IDL.Text, IDL.Nat],
      [],
      [],
    ),
